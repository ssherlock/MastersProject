...
constructedVariableData.to_csv("C:\\Users\\Chris\\OneDrive\\Masters\\Project\\Code\\data\\" + globalCurrentPump + "VariablesAllVariables" + str(globalPredHorizon) + ".csv", index = False)