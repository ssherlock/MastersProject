...
print("\nConstructedVariableData pump:", globalCurrentPump, " globalPred = ", globalPredHorizon)
print(constructedVariableData)

constructedVariableData.to_csv("C:\\Users\\Chris\\OneDrive\\Masters\\Project\\Code\\data\\" + str(globalCurrentPump) + "VariablesGlucose" + str(globalPredHorizon) + ".csv", index = False)